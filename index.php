...
<body>
    ...
    <div class="department_area section_gap mt-25">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="dpmt_right">
                        ...
                        <p>There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s exciting to think about setting up your own viewing station. In the life of any aspiring astronomer that it is time to buy
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_course">
                        ...
                        <div class="course_content">
                            ...
                            <p>When television was young, there was a huge popular show based on the still popular fictional character of Superman.
                            </p>
                            <div class="course_meta d-flex justify-content-between">
                                ...
                                <div>
                                    <span class="price">Know More</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        ...
                        <p>Lorem ipsum dolor sit amet consec tetur adipisicing elit, sed do eiusmod tempor incididunt labore dolor sit amet consec tetur adipisicing elit, sed do eiusmod tempor sed do eiusmod tempor incididunt labore dolor sit amet consec
                            tetur adipisicing elit, seddo eiusmod tempor.</p>
                    </div>
                </div>
                <!-- single features -->
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        ...
                        <h4>25000+ Courses</h4>
                        <p>Lorem ipsum dolor sit amet consec tetur adipis icing elit, sed do eiusmod tempor incididunt labore dolor sit amet consec.</p>
                    </div>
                </div>
                <!-- single features -->
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        ...
                        <p>Lorem ipsum dolor sit amet consec tetur adipisicing elit, sed do eiusmod tempor incididunt labore dolor sit amet consec tetur adipisicing elit sed do eiusmod.</p>
                    </div>
                </div>
                <!-- single features -->
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-7">
                    <div class="row clock_sec clockdiv" id="clockdiv">
                        ...
                        <div class="col clockinner1 clockinner">
                            <h1 class="">25</h1><br/>
                            <span class="smalltext">Courses</span>
                        </div>
                        ...
                        <div class="col clockinner clockinner1">
                            <h1 class="">20+</h1><br/>
                            <span class="smalltext">Events</span>
                        </div>
                        <div class="col clockinner clockinner1">
                            <h1 class="">7</h1><br/>
                            <span class="smalltext">Tutors</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 offset-lg-1">
                    <div class="register_form">
                        <h3>Know about Courses</h3>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-7">
                                        <div class="event_details">
                                            ...
                                            <p>Lorem ipsum dolor sit amet consec tetur adipisicing elit, sed do eiusmod tempor incididunt labore dolor sit amet consec tetur adipisicing elit sed.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
